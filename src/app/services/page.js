    ...
    <>
      ...
      <div className='servicesBody'>
        ...
        <main>
          <div className='servicesItems'>
            <div className='item item1' onMouseEnter={() => handleMouseEnter('item1')} onMouseLeave={handleMouseLeave}>
              <h4>sem & seo</h4>
            ...
            <div className='item item2' onMouseEnter={() => handleMouseEnter('item2')} onMouseLeave={handleMouseLeave}>
            ...
            <div className='item item3' onMouseEnter={() => handleMouseEnter('item3')} onMouseLeave={handleMouseLeave}>
            ...
            <div className='item item4' onMouseEnter={() => handleMouseEnter('item4')} onMouseLeave={handleMouseLeave}>
            ...
            <div className='item item5' onMouseEnter={() => handleMouseEnter('item5')} onMouseLeave={handleMouseLeave}>
              <h4>consultoría</h4>
      ...
      {isOverItem && (
        <div className='custom-cursor' style={{ 
          ...
          top: position.y, 
          backgroundImage: `url(${
            currentItem === 'item1' ? '/service-sem&seo.svg' : 
            currentItem === 'item2' ? '/service-branding.svg' : 
            currentItem === 'item3' ? '/service-social.svg' :
            currentItem === 'item4' ? '/service-uxui.svg' :
            currentItem === 'item5' ? '/service-consultant.svg' : 
            '/default-image.svg'
          })` 
        }}></div>
      )}
