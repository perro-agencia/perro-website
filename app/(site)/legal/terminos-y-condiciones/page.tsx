    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <p className="text-brand-white/80 text-lg leading-relaxed">
          ...
          <br /><br />
          <strong className="text-brand-white">Información recopilada</strong>
          <br />
          ...
          <br /><br />
          <strong className="text-brand-white">Uso de la información recopilada</strong>
          <br />
          ...
          <br /><br />
          <strong className="text-brand-white">Cookies</strong>
          <br />
          ...
          <br /><br />
          <strong className="text-brand-white">Enlaces a terceros</strong>
          <br />
          ...
          <br /><br />
          <strong className="text-brand-white">Control de su información personal</strong>
          <br />
