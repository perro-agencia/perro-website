...
const chipVariants = cva(
  "inline-block text-[13px] md:text-md uppercase rounded-full border font-light transition-colors duration-300",
  {
    variants: {
      variant: {
        primary:
        ...
        outline:
          "border-brand-white text-brand-white hover:text-brand-accent-02 hover:border-brand-accent-02 py-3 px-8",
      },
    },
    defaultVariants: {
      variant: "primary",
