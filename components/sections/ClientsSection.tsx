          ...
          {clients.map((client) => (
            <motion.div key={client.name} variants={itemVariants}>
              <Link
                ...
                className="flex items-center justify-center border rounded-sm border-black hover:border-white hover:rounded-lg hover:scale-[1.03] hover:shadow-[0_0_24px_-8px_rgba(255,255,255,1)] transition-all duration-300 ease-in-out"
              >
                <Image
                  src={client.image}
                  alt={client.name}
